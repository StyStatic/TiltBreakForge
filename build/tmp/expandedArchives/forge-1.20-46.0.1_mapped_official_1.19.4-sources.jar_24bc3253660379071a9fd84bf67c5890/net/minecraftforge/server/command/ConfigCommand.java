    ...
    public static class ShowFile {
        ...
        private static int showFile(final CommandContext<CommandSourceStack> context) {
            ...
            if (configFileName != null) {
                ...
                context.getSource().m_288197_(() -> Component.translatable("commands.config.getwithtype",
                        modId, type,
                ...
                context.getSource().m_288197_(() -> Component.translatable("commands.config.noconfig", modId, type),
                        true);
            }
            return 0;
        }
