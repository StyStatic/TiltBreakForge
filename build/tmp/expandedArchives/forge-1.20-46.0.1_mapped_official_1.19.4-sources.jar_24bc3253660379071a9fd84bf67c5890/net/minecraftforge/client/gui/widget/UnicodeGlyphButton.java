...
public class UnicodeGlyphButton extends ExtendedButton
{
    ...
    public void m_88315_(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick)
    {
        if (this.visible)
        {
            ...
            guiGraphics.m_280168_().pushPose();
            guiGraphics.m_280168_().scale(glyphScale, glyphScale, 1.0F);
            guiGraphics.m_280653_(mc.font, Component.literal(glyph),
            ...
            guiGraphics.m_280168_().popPose();

            guiGraphics.m_280653_(mc.font, buttonText, (int) (this.getX() + (this.width / 2) + (glyphWidth / glyphScale)),
