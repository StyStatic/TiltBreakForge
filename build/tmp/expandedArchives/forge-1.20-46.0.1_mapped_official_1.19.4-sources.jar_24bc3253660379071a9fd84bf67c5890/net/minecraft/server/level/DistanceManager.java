...
public abstract class DistanceManager {
   ...
   static final int PLAYER_TICKET_LEVEL = ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING);
   ...
   private static int getTicketLevelAt(SortedArraySet<Ticket<?>> p_140798_) {
      return !p_140798_.isEmpty() ? p_140798_.first().getTicketLevel() : ChunkLevel.f_286967_ + 1;
   }
   ...
   private int getPlayerTicketLevel() {
      return Math.max(0, ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING) - this.simulationDistance);
   }

   public boolean inEntityTickingRange(long p_183914_) {
      return ChunkLevel.m_287155_(this.tickingTicketsTracker.getLevel(p_183914_));
   }

   public boolean inBlockTickingRange(long p_183917_) {
      return ChunkLevel.m_287283_(this.tickingTicketsTracker.getLevel(p_183917_));
   }
   ...
   class ChunkTicketTracker extends ChunkTracker {
      ...
      protected void setLevel(long p_140880_, int p_140881_) {
         ...
         int i = chunkholder == null ? f_286988_ : chunkholder.getTicketLevel();
         if (i != p_140881_) {
