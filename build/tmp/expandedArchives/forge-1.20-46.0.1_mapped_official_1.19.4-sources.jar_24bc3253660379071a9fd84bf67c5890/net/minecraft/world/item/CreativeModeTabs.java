...
public class CreativeModeTabs {
   public static final ResourceKey<CreativeModeTab> BUILDING_BLOCKS = m_280238_("building_blocks");
   public static final ResourceKey<CreativeModeTab> COLORED_BLOCKS = m_280238_("colored_blocks");
   public static final ResourceKey<CreativeModeTab> NATURAL_BLOCKS = m_280238_("natural_blocks");
   public static final ResourceKey<CreativeModeTab> FUNCTIONAL_BLOCKS = m_280238_("functional_blocks");
   public static final ResourceKey<CreativeModeTab> REDSTONE_BLOCKS = m_280238_("redstone_blocks");
   public static final ResourceKey<CreativeModeTab> HOTBAR = m_280238_("hotbar");
   public static final ResourceKey<CreativeModeTab> SEARCH = m_280238_("search");
   public static final ResourceKey<CreativeModeTab> TOOLS_AND_UTILITIES = m_280238_("tools_and_utilities");
   public static final ResourceKey<CreativeModeTab> COMBAT = m_280238_("combat");
   public static final ResourceKey<CreativeModeTab> FOOD_AND_DRINKS = m_280238_("food_and_drinks");
   public static final ResourceKey<CreativeModeTab> INGREDIENTS = m_280238_("ingredients");
   public static final ResourceKey<CreativeModeTab> SPAWN_EGGS = m_280238_("spawn_eggs");
   public static final ResourceKey<CreativeModeTab> OP_BLOCKS = m_280238_("op_blocks");
   public static final ResourceKey<CreativeModeTab> INVENTORY = m_280238_("inventory");
   ...
   private static ResourceKey<CreativeModeTab> m_280238_(String p_281544_) {
      return ResourceKey.create(Registries.f_279569_, new ResourceLocation(p_281544_));
   }

   public static CreativeModeTab m_280294_(Registry<CreativeModeTab> p_283144_) {
      ...
      Registry.register(p_283144_, NATURAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2).title(Component.translatable("itemGroup.natural")).icon(() -> {
         ...
         p_288946_.accept(Items.f_276698_);
         ...
         p_288946_.accept(Items.f_276468_);
         ...
         p_288946_.accept(Items.f_276594_);
      ...
      Registry.register(p_283144_, FUNCTIONAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3).title(Component.translatable("itemGroup.functional")).icon(() -> {
         ...
         p_277298_.accept(Items.f_276672_);
      ...
      Registry.register(p_283144_, REDSTONE_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 4).title(Component.translatable("itemGroup.redstone")).icon(() -> {
         ...
         p_259444_.accept(Items.f_276539_);
      ...
      Registry.register(p_283144_, TOOLS_AND_UTILITIES, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 0).title(Component.translatable("itemGroup.tools")).icon(() -> {
         ...
         p_284858_.accept(Items.f_283830_);
      }).build());
      ...
      Registry.register(p_283144_, INGREDIENTS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3).title(Component.translatable("itemGroup.ingredients")).icon(() -> {
         ...
         p_277300_.accept(Items.f_279633_);
         p_277300_.accept(Items.f_279642_);
         p_277300_.accept(Items.f_279634_);
         p_277300_.accept(Items.f_279567_);
         p_277300_.accept(Items.f_279583_);
         p_277300_.accept(Items.f_279650_);
         p_277300_.accept(Items.f_279619_);
         p_277300_.accept(Items.f_279616_);
         p_277300_.accept(Items.f_279584_);
         p_277300_.accept(Items.f_279623_);
         p_277300_.accept(Items.f_279606_);
         p_277300_.accept(Items.f_279598_);
         p_277300_.accept(Items.f_279559_);
         p_277300_.accept(Items.f_279560_);
         p_277300_.accept(Items.f_279647_);
         p_277300_.accept(Items.f_279528_);
         p_277300_.accept(Items.f_279545_);
         p_277300_.accept(Items.f_279529_);
         p_277300_.accept(Items.f_279570_);
         p_277300_.accept(Items.f_279636_);
         ...
         p_277300_.accept(Items.f_276612_);
         p_277300_.accept(Items.f_276465_);
         p_277300_.accept(Items.f_276546_);
         p_277300_.accept(Items.f_276433_);
         p_277300_.accept(Items.WARD_ARMOR_TRIM_SMITHING_TEMPLATE);
         p_277300_.accept(Items.f_276537_);
   ...
   public static void m_280019_() {
      ...
      for(ResourceKey<CreativeModeTab> resourcekey : BuiltInRegistries.f_279662_.registryKeySet()) {
         CreativeModeTab creativemodetab = BuiltInRegistries.f_279662_.getOrThrow(resourcekey);
   ...
   public static CreativeModeTab getDefaultTab() {
      return BuiltInRegistries.f_279662_.getOrThrow(BUILDING_BLOCKS);
   }
   ...
   public static List<CreativeModeTab> tabs() {
      return m_280350_().filter(CreativeModeTab::shouldDisplay).toList();
   }
