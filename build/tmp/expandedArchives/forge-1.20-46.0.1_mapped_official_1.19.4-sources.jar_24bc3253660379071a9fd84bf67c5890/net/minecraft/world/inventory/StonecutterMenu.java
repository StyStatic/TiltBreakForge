...
public class StonecutterMenu extends AbstractContainerMenu {
   ...
   public StonecutterMenu(int p_40297_, Inventory p_40298_, final ContainerLevelAccess p_40299_) {
      ...
      this.level = p_40298_.player.getLevel();
      ...
      this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
         ...
         public void onTake(Player p_150672_, ItemStack p_150673_) {
            p_150673_.onCraftedBy(p_150672_.getLevel(), p_150672_, p_150673_.getCount());
            StonecutterMenu.this.resultContainer.m_58395_(p_150672_, this.m_280281_());
         ...
         private List<ItemStack> m_280281_() {
   ...
   public ItemStack quickMoveStack(Player p_40328_, int p_40329_) {
      ...
      if (slot != null && slot.hasItem()) {
         ...
         if (p_40329_ == 1) {
            item.onCraftedBy(itemstack1, p_40328_.getLevel(), p_40328_);
