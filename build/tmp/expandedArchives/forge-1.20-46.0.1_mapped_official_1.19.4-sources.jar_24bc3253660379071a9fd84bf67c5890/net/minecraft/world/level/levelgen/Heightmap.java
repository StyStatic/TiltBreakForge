...
public class Heightmap {
   ...
   public static enum Types implements StringRepresentable {
      ...
      MOTION_BLOCKING("MOTION_BLOCKING", Heightmap.Usage.CLIENT, (p_284915_) -> {
         return p_284915_.m_280555_() || !p_284915_.getFluidState().isEmpty();
      }),
      MOTION_BLOCKING_NO_LEAVES("MOTION_BLOCKING_NO_LEAVES", Heightmap.Usage.LIVE_WORLD, (p_284914_) -> {
         return (p_284914_.m_280555_() || !p_284914_.getFluidState().isEmpty()) && !(p_284914_.getBlock() instanceof LeavesBlock);
      });
