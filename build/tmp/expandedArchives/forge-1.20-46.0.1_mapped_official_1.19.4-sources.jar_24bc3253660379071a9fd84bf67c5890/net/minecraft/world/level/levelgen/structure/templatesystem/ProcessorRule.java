...
public class ProcessorRule {
   ...
   public static final Codec<ProcessorRule> CODEC = RecordCodecBuilder.create((p_277334_) -> {
      ...
      }), RuleBlockEntityModifier.f_276484_.optionalFieldOf("block_entity_modifier", f_276568_).forGetter((p_277333_) -> {
         return p_277333_.f_276504_;
   ...
   public ProcessorRule(RuleTest p_74227_, RuleTest p_74228_, PosRuleTest p_74229_, BlockState p_74230_) {
      this(p_74227_, p_74228_, p_74229_, p_74230_, f_276568_);
   }
   ...
   @Nullable
   public CompoundTag m_276991_(RandomSource p_277551_, @Nullable CompoundTag p_277867_) {
      return this.f_276504_.m_276854_(p_277551_, p_277867_);
   }
}