...
public class PrimaryLevelData implements ServerLevelData, WorldData {
   ...
   public PrimaryLevelData(LevelSettings p_251081_, WorldOptions p_251666_, PrimaryLevelData.SpecialWorldProperty p_252268_, Lifecycle p_251714_) {
      this((DataFixer)null, SharedConstants.getCurrentVersion().getDataVersion().getVersion(), (CompoundTag)null, false, 0, 0, 0, 0.0F, 0L, 0L, 19133, 0, 0, false, 0, false, false, false, WorldBorder.DEFAULT_SETTINGS, 0, 0, (UUID)null, Sets.newLinkedHashSet(), new HashSet<>(), new TimerQueue<>(TimerCallbacks.SERVER_CALLBACKS), (CompoundTag)null, EndDragonFight.Data.f_289709_, p_251081_.copy(), p_251666_, p_252268_, p_251714_);
   }
   ...
   public static <T> PrimaryLevelData parse(Dynamic<T> p_78531_, DataFixer p_78532_, int p_78533_, @Nullable CompoundTag p_78534_, LevelSettings p_78535_, LevelVersion p_78536_, PrimaryLevelData.SpecialWorldProperty p_250651_, WorldOptions p_251864_, Lifecycle p_78538_) {
      ...
      }).collect(Collectors.toSet()), new TimerQueue<>(TimerCallbacks.SERVER_CALLBACKS, p_78531_.get("ScheduledEvents").asStream()), (CompoundTag)p_78531_.get("CustomBossEvents").orElseEmptyMap().getValue(), p_78531_.get("DragonFight").read(EndDragonFight.Data.f_289707_).resultOrPartial(LOGGER::error).orElse(EndDragonFight.Data.f_289709_), p_78535_, p_251864_, p_250651_, p_78538_).withConfirmedWarning(p_78538_ != Lifecycle.stable() && p_78531_.get("confirmedExperimentalSettings").asBoolean(false));
   }
   ...
   private void setTagData(RegistryAccess p_78546_, CompoundTag p_78547_, @Nullable CompoundTag p_78548_) {
      p_78547_.put("ServerBrands", m_277055_(this.knownServerBrands));
      p_78547_.putBoolean("WasModded", this.wasModded);
      if (!this.f_276525_.isEmpty()) {
         p_78547_.put("removed_features", m_277055_(this.f_276525_));
      }
      ...
      p_78547_.put("DragonFight", Util.getOrThrow(EndDragonFight.Data.f_289707_.encodeStart(NbtOps.INSTANCE, this.endDragonFightData), IllegalStateException::new));
      if (p_78548_ != null) {
   ...
   public Set<String> m_276907_() {
      return Set.copyOf(this.f_276525_);
   }
