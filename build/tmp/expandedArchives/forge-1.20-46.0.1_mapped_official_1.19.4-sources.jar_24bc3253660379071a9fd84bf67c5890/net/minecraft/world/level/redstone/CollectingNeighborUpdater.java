...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   static record ShapeUpdate(Direction direction, BlockState state, BlockPos pos, BlockPos neighborPos, int updateFlags, int f_276599_) implements CollectingNeighborUpdater.NeighborUpdates {
      public boolean runNext(Level p_230716_) {
         NeighborUpdater.executeShapeUpdate(p_230716_, this.direction, this.state, this.pos, this.neighborPos, this.updateFlags, this.f_276599_);
         return false;
      }
   }
