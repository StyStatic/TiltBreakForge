...
public class AreaEffectCloud extends Entity implements TraceableEntity {
   ...
   public void tick() {
      ...
      if (this.getLevel().isClientSide) {
         ...
         for(int j = 0; j < i; ++j) {
            ...
            this.getLevel().addAlwaysVisibleParticle(particleoptions, d0, d2, d4, d5, d6, d7);
         }
      } else {
         ...
         if (this.tickCount % 5 == 0) {
            ...
            if (list.isEmpty()) {
               ...
               List<LivingEntity> list1 = this.getLevel().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox());
               if (!list1.isEmpty()) {
   ...
   public LivingEntity getOwner() {
      if (this.owner == null && this.ownerUUID != null && this.getLevel() instanceof ServerLevel) {
         Entity entity = ((ServerLevel)this.getLevel()).getEntity(this.ownerUUID);
