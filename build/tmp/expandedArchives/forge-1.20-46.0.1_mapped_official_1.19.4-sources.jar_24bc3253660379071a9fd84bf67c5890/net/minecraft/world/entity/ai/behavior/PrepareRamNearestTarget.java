...
public class PrepareRamNearestTarget<E extends PathfinderMob> extends Behavior<E> {
   ...
   private boolean isWalkableBlock(PathfinderMob p_147746_, BlockPos p_147747_) {
      return p_147746_.getNavigation().isStableDestination(p_147747_) && p_147746_.getPathfindingMalus(WalkNodeEvaluator.getBlockPathTypeStatic(p_147746_.getLevel(), p_147747_.mutable())) == 0.0F;
   }
