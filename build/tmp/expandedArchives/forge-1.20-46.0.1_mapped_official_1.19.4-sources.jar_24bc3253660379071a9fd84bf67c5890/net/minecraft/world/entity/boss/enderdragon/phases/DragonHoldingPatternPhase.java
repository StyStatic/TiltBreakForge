...
public class DragonHoldingPatternPhase extends AbstractDragonPhaseInstance {
   ...
   private void findNewTarget() {
      if (this.currentPath != null && this.currentPath.isDone()) {
         BlockPos blockpos = this.dragon.getLevel().getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, new BlockPos(EndPodiumFeature.m_287210_(this.dragon.m_287165_())));
         ...
         Player player = this.dragon.getLevel().getNearestPlayer(NEW_TARGET_TARGETING, this.dragon, (double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ());
         double d0;
         if (player != null) {
