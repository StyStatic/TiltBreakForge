...
public class SmallFireball extends Fireball {
   ...
   protected void onHitBlock(BlockHitResult p_37384_) {
      ...
      if (!this.getLevel().isClientSide) {
         ...
         if (!(entity instanceof Mob) || net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.getLevel(), entity)) {
            BlockPos blockpos = p_37384_.getBlockPos().relative(p_37384_.getDirection());
            if (this.getLevel().isEmptyBlock(blockpos)) {
               this.getLevel().setBlockAndUpdate(blockpos, BaseFireBlock.getState(this.getLevel(), blockpos));
            }
         }
