      ...
      if (this.minecraft.player.blockActionRestricted(this.minecraft.level, p_105270_, this.localPlayerMode)) {
         ...
         if (this.localPlayerMode.isCreative()) {
            ...
            this.startPrediction(this.minecraft.level, (p_233728_) -> {
               ...
               if (flag && blockstate1.getDestroyProgress(this.minecraft.player, this.minecraft.player.getLevel(), p_105270_) >= 1.0F) {
                  this.destroyBlock(p_105270_);
               } else {
                  ...
                  this.minecraft.level.destroyBlockProgress(this.minecraft.player.getId(), this.destroyBlockPos, this.m_287167_());
               }
   ...
   public boolean continueDestroyBlock(BlockPos p_105284_, Direction p_105285_) {
      ...
      if (this.destroyDelay > 0) {
         ...
         if (blockstate.isAir()) {
            ...
            this.destroyProgress += blockstate.getDestroyProgress(this.minecraft.player, this.minecraft.player.getLevel(), p_105284_);
