...
public class WorldSessionTelemetryManager {
   ...
   public void m_286034_(Level p_286825_, Advancement p_286627_) {
      ResourceLocation resourcelocation = p_286627_.getId();
      if (p_286627_.m_285828_() && "minecraft".equals(resourcelocation.getNamespace())) {
         long i = p_286825_.getGameTime();
         this.eventSender.send(TelemetryEventType.f_285568_, (p_286184_) -> {
            p_286184_.put(TelemetryProperty.f_285565_, resourcelocation.toString());
            p_286184_.put(TelemetryProperty.f_285625_, i);
         });
      }
