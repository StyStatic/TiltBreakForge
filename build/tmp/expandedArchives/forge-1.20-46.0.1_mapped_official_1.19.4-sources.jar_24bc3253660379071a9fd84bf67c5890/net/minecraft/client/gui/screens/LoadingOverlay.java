...
public class LoadingOverlay extends Overlay {
   ...
   public void m_88315_(GuiGraphics p_281839_, int p_282704_, int p_283650_, float p_283394_) {
      int i = p_281839_.m_280182_();
      int j = p_281839_.m_280206_();
      ...
      if (f >= 1.0F) {
         if (this.minecraft.screen != null) {
            this.minecraft.screen.m_88315_(p_281839_, 0, 0, p_283394_);
         }

         int l = Mth.ceil((1.0F - Mth.clamp(f - 1.0F, 0.0F, 1.0F)) * 255.0F);
         p_281839_.m_285944_(RenderType.m_286086_(), 0, 0, i, j, replaceAlpha(BRAND_BACKGROUND.getAsInt(), l));
         f2 = 1.0F - Mth.clamp(f - 1.0F, 0.0F, 1.0F);
      } else if (this.fadeIn) {
         if (this.minecraft.screen != null && f1 < 1.0F) {
            this.minecraft.screen.m_88315_(p_281839_, p_282704_, p_283650_, p_283394_);
         }

         int l1 = Mth.ceil(Mth.clamp((double)f1, 0.15D, 1.0D) * 255.0D);
         p_281839_.m_285944_(RenderType.m_286086_(), 0, 0, i, j, replaceAlpha(BRAND_BACKGROUND.getAsInt(), l1));
      ...
      int j2 = (int)((double)p_281839_.m_280182_() * 0.5D);
      int k2 = (int)((double)p_281839_.m_280206_() * 0.5D);
      double d1 = Math.min((double)p_281839_.m_280182_() * 0.75D, (double)p_281839_.m_280206_()) * 0.25D;
      int i1 = (int)(d1 * 0.5D);
      double d0 = d1 * 4.0D;
      int j1 = (int)(d0 * 0.5D);
      ...
      p_281839_.m_280246_(1.0F, 1.0F, 1.0F, f2);
      p_281839_.m_280411_(MOJANG_STUDIOS_LOGO_LOCATION, j2 - j1, k2 - i1, j1, (int)d1, -0.0625F, 0.0F, 120, 60, 120, 120);
      p_281839_.m_280411_(MOJANG_STUDIOS_LOGO_LOCATION, j2, k2 - i1, j1, (int)d1, 0.0625F, 60.0F, 120, 60, 120, 120);
      p_281839_.m_280246_(1.0F, 1.0F, 1.0F, 1.0F);
      ...
      if (this.fadeOutStart == -1L && this.reload.isDone() && (!this.fadeIn || f1 >= 2.0F)) {
         ...
         if (this.minecraft.screen != null) {
            this.minecraft.screen.init(this.minecraft, p_281839_.m_280182_(), p_281839_.m_280206_());
         }
      }
   ...
   private void drawProgressBar(GuiGraphics p_283125_, int p_96184_, int p_96185_, int p_96186_, int p_96187_, float p_96188_) {
      ...
      p_283125_.m_280509_(p_96184_ + 2, p_96185_ + 2, p_96184_ + i, p_96187_ - 2, k);
      p_283125_.m_280509_(p_96184_ + 1, p_96185_, p_96186_ - 1, p_96185_ + 1, k);
      p_283125_.m_280509_(p_96184_ + 1, p_96187_, p_96186_ - 1, p_96187_ - 1, k);
      p_283125_.m_280509_(p_96184_, p_96185_, p_96184_ + 1, p_96187_, k);
      p_283125_.m_280509_(p_96186_, p_96185_, p_96186_ - 1, p_96187_, k);
   }
