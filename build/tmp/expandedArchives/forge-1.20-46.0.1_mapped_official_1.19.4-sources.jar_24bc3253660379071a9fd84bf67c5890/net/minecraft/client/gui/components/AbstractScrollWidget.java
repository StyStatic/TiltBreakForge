...
public abstract class AbstractScrollWidget extends AbstractWidget implements Renderable, GuiEventListener {
   ...
   public void renderWidget(GuiGraphics p_282213_, int p_282468_, int p_282209_, float p_283300_) {
      if (this.visible) {
         ...
         p_282213_.m_280588_(this.getX() + 1, this.getY() + 1, this.getX() + this.width - 1, this.getY() + this.height - 1);
         p_282213_.m_280168_().pushPose();
         p_282213_.m_280168_().translate(0.0D, -this.scrollAmount, 0.0D);
         this.m_239197_(p_282213_, p_282468_, p_282209_, p_283300_);
         p_282213_.m_280168_().popPose();
         p_282213_.m_280618_();
   ...
   protected void renderBackground(GuiGraphics p_282207_) {
      this.m_289749_(p_282207_, this.getX(), this.getY(), this.getWidth(), this.getHeight());
   }

   protected void m_289749_(GuiGraphics p_289776_, int p_289792_, int p_289795_, int p_289775_, int p_289762_) {
      int i = this.isFocused() ? -1 : -6250336;
      p_289776_.m_280509_(p_289792_, p_289795_, p_289792_ + p_289775_, p_289795_ + p_289762_, i);
      p_289776_.m_280509_(p_289792_ + 1, p_289795_ + 1, p_289792_ + p_289775_ - 1, p_289795_ + p_289762_ - 1, -16777216);
   }
   ...
   private void renderScrollBar(GuiGraphics p_282305_) {
      ...
      int i1 = l + i;
      p_282305_.m_280509_(j, l, k, i1, -8355712);
      p_282305_.m_280509_(j, l, k - 1, i1 - 1, -4144960);
   }
   ...
   protected abstract void m_239197_(GuiGraphics p_282975_, int p_239199_, int p_239200_, float p_239201_);
}