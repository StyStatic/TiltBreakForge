...
public abstract class AbstractWidget implements Renderable, GuiEventListener, LayoutElement, NarratableEntry {
   ...
   protected static void m_280138_(GuiGraphics p_281620_, Font p_282651_, Component p_281467_, int p_283621_, int p_282084_, int p_283398_, int p_281938_, int p_283471_) {
      ...
      if (i > k) {
         ...
         p_281620_.m_280588_(p_283621_, p_282084_, p_283398_, p_281938_);
         p_281620_.m_280430_(p_282651_, p_281467_, p_283621_ - (int)d3, j, p_283471_);
         p_281620_.m_280618_();
      } else {
         p_281620_.m_280653_(p_282651_, p_281467_, (p_283621_ + p_283398_) / 2, j, p_283471_);
      }

   }

   protected void m_280372_(GuiGraphics p_281857_, Font p_282790_, int p_282664_, int p_282944_) {
      int i = this.getX() + p_282664_;
      int j = this.getX() + this.getWidth() - p_282664_;
      m_280138_(p_281857_, p_282790_, this.getMessage(), i, this.getY(), j, this.getY() + this.getHeight(), p_282944_);
   }

   public void m_280322_(GuiGraphics p_283546_, ResourceLocation p_281674_, int p_281808_, int p_282444_, int p_283651_, int p_281601_, int p_283472_, int p_282390_, int p_281441_, int p_281711_, int p_281541_) {
      int i = p_281601_;
      if (!this.isActive()) {
