...
public class HangingSignEditScreen extends AbstractSignEditScreen {
   ...
   protected void m_280050_(GuiGraphics p_282472_, BlockState p_282359_) {
      p_282472_.m_280168_().translate((float)this.width / 2.0F, 125.0F, 50.0F);
   }

   protected void m_245490_(GuiGraphics p_282580_, BlockState p_283648_) {
      p_282580_.m_280168_().translate(0.0F, -13.0F, 0.0F);
      p_282580_.m_280168_().scale(4.5F, 4.5F, 1.0F);
      p_282580_.m_280163_(this.texture, -8, -8, 0.0F, 0.0F, 16, 16, 16, 16);
   }
