...
public class TabNavigationBar extends AbstractContainerEventHandler implements Renderable, GuiEventListener, NarratableEntry {
   ...
   public void m_88315_(GuiGraphics p_281720_, int p_282085_, int p_281687_, float p_283048_) {
      p_281720_.m_280509_(0, 0, this.width, 24, -16777216);
      p_281720_.m_280163_(CreateWorldScreen.HEADER_SEPERATOR, 0, this.layout.getY() + this.layout.getHeight() - 2, 0.0F, 0.0F, this.width, 2, 32, 2);

      for(TabButton tabbutton : this.tabButtons) {
         tabbutton.m_88315_(p_281720_, p_282085_, p_281687_, p_283048_);
      }
