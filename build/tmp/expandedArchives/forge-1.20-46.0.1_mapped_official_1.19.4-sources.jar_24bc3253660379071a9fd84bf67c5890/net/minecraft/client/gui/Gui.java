...
public class Gui {
   ...
   public void m_280421_(GuiGraphics p_282884_, float p_282611_) {
      Window window = this.minecraft.getWindow();
      this.screenWidth = p_282884_.m_280182_();
      this.screenHeight = p_282884_.m_280206_();
      Font font = this.getFont();
      RenderSystem.enableBlend();
      if (Minecraft.useFancyGraphics()) {
         this.m_280154_(p_282884_, this.minecraft.getCameraEntity());
      } else {
      ...
      if (this.minecraft.options.getCameraType().isFirstPerson()) {
         if (this.minecraft.player.isScoping()) {
            this.m_280278_(p_282884_, this.scopeScale);
         } else {
            this.scopeScale = 0.5F;
            ItemStack itemstack = this.minecraft.player.getInventory().getArmor(3);
            if (itemstack.is(Blocks.CARVED_PUMPKIN.asItem())) {
               this.m_280155_(p_282884_, PUMPKIN_BLUR_LOCATION, 1.0F);
            }
         }
      }

      if (this.minecraft.player.getTicksFrozen() > 0) {
         this.m_280155_(p_282884_, POWDER_SNOW_OUTLINE_LOCATION, this.minecraft.player.getPercentFrozen());
      }

      float f1 = Mth.lerp(p_282611_, this.minecraft.player.oPortalTime, this.minecraft.player.portalTime);
      if (f1 > 0.0F && !this.minecraft.player.hasEffect(MobEffects.CONFUSION)) {
         this.m_280379_(p_282884_, f1);
      }

      if (this.minecraft.gameMode.getPlayerMode() == GameType.SPECTATOR) {
         this.spectatorGui.m_280623_(p_282884_);
      } else if (!this.minecraft.options.hideGui) {
         this.m_280518_(p_282611_, p_282884_);
      }

      if (!this.minecraft.options.hideGui) {
         RenderSystem.enableBlend();
         this.m_280130_(p_282884_);
         this.minecraft.getProfiler().push("bossHealth");
         this.bossOverlay.m_280652_(p_282884_);
         this.minecraft.getProfiler().pop();
         if (this.minecraft.gameMode.canHurtPlayer()) {
            this.m_280173_(p_282884_);
         }

         this.m_280250_(p_282884_);
         ...
         if (playerrideablejumping != null) {
            this.m_280069_(playerrideablejumping, p_282884_, i);
         } else if (this.minecraft.gameMode.hasExperience()) {
            this.m_280276_(p_282884_, i);
         }

         if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR) {
            this.m_280295_(p_282884_);
         } else if (this.minecraft.player.isSpectator()) {
            this.spectatorGui.m_280365_(p_282884_);
         }
      }
      ...
      if (this.minecraft.player.getSleepTimer() > 0) {
         ...
         p_282884_.m_285944_(RenderType.m_286086_(), 0, 0, this.screenWidth, this.screenHeight, j);
         this.minecraft.getProfiler().pop();
      }

      if (this.minecraft.isDemo()) {
         this.m_280339_(p_282884_);
      }

      this.m_280523_(p_282884_);
      ...
      if (!this.minecraft.options.hideGui) {
         if (this.overlayMessageString != null && this.overlayMessageTime > 0) {
            ...
            if (j1 > 8) {
               p_282884_.m_280168_().pushPose();
               p_282884_.m_280168_().translate((float)(this.screenWidth / 2), (float)(this.screenHeight - 68), 0.0F);
               int l1 = 16777215;
               ...
               p_282884_.m_280430_(font, this.overlayMessageString, -l / 2, -4, l1 | k);
               p_282884_.m_280168_().popPose();
            }
         ...
         if (this.title != null && this.titleTime > 0) {
            ...
            if (k1 > 8) {
               p_282884_.m_280168_().pushPose();
               p_282884_.m_280168_().translate((float)(this.screenWidth / 2), (float)(this.screenHeight / 2), 0.0F);
               RenderSystem.enableBlend();
               p_282884_.m_280168_().pushPose();
               p_282884_.m_280168_().scale(4.0F, 4.0F, 4.0F);
               int i2 = k1 << 24 & -16777216;
               int j2 = font.width(this.title);
               this.drawBackdrop(p_282884_, font, -10, j2, 16777215 | i2);
               p_282884_.m_280430_(font, this.title, -j2 / 2, -10, 16777215 | i2);
               p_282884_.m_280168_().popPose();
               if (this.subtitle != null) {
                  p_282884_.m_280168_().pushPose();
                  p_282884_.m_280168_().scale(2.0F, 2.0F, 2.0F);
                  int l2 = font.width(this.subtitle);
                  this.drawBackdrop(p_282884_, font, 5, l2, 16777215 | i2);
                  p_282884_.m_280430_(font, this.subtitle, -l2 / 2, 5, 16777215 | i2);
                  p_282884_.m_280168_().popPose();
               }
         ...
         this.subtitleOverlay.m_280227_(p_282884_);
         ...
         if (objective1 != null) {
            this.m_280030_(p_282884_, objective1);
         }
         ...
         this.chat.m_280165_(p_282884_, this.tickCount, i3, i1);
         this.minecraft.getProfiler().pop();
         ...
         if (!this.minecraft.options.keyPlayerList.isDown() || this.minecraft.isLocalServer() && this.minecraft.player.connection.getListedOnlinePlayers().size() <= 1 && objective1 == null) {
            ...
            this.tabList.m_280406_(p_282884_, this.screenWidth, scoreboard, objective1);
         }

         this.m_280266_(p_282884_);
      }
   ...
   protected void drawBackdrop(GuiGraphics p_282548_, Font p_93041_, int p_93042_, int p_93043_, int p_93044_) {
      ...
      if (i != 0) {
         int j = -p_93043_ / 2;
         p_282548_.m_280509_(j - 2, p_93042_ - 2, j + p_93043_ + 2, p_93042_ + 9 + 2, FastColor.ARGB32.multiply(i, p_93044_));
      }
      ...
      if (options.getCameraType().isFirstPerson()) {
         if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR || this.canRenderCrosshairForSpectator(this.minecraft.hitResult)) {
            if (options.renderDebug && !options.hideGui && !this.minecraft.player.isReducedDebugInfo() && !options.reducedDebugInfo().get()) {
               ...
               posestack.pushPose();
               posestack.mulPoseMatrix(p_282828_.m_280168_().last().pose());
               ...
               int i = 15;
               p_282828_.m_280218_(f_279580_, (this.screenWidth - 15) / 2, (this.screenHeight - 15) / 2, 0, 0, 15, 15);
               if (this.minecraft.options.attackIndicator().get() == AttackIndicatorStatus.CROSSHAIR) {
                  ...
                  if (flag) {
                     p_282828_.m_280218_(f_279580_, k, j, 68, 94, 16, 16);
                  } else if (f < 1.0F) {
                     int l = (int)(f * 17.0F);
                     p_282828_.m_280218_(f_279580_, k, j, 36, 94, 16, 4);
                     p_282828_.m_280218_(f_279580_, k, j, 52, 94, l, 4);
                  }
               }
         ...
         for(MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (mobeffectinstance.showIcon()) {
               ...
               if (mobeffectinstance.isAmbient()) {
                  p_282812_.m_280218_(AbstractContainerScreen.INVENTORY_LOCATION, i, j, 165, 166, 24, 24);
               } else {
                  p_282812_.m_280218_(AbstractContainerScreen.INVENTORY_LOCATION, i, j, 141, 166, 24, 24);
   ...
   public void m_280518_(float p_283031_, GuiGraphics p_282108_) {
      ...
      if (player != null) {
         ...
         int j = 182;
         int k = 91;
         p_282108_.m_280168_().pushPose();
         p_282108_.m_280168_().translate(0.0F, 0.0F, -90.0F);
         p_282108_.m_280218_(WIDGETS_LOCATION, i - 91, this.screenHeight - 22, 0, 0, 182, 22);
         p_282108_.m_280218_(WIDGETS_LOCATION, i - 91 - 1 + player.getInventory().selected * 20, this.screenHeight - 22 - 1, 0, 22, 24, 22);
         if (!itemstack.isEmpty()) {
            if (humanoidarm == HumanoidArm.LEFT) {
               p_282108_.m_280218_(WIDGETS_LOCATION, i - 91 - 29, this.screenHeight - 23, 24, 22, 29, 24);
            } else {
               p_282108_.m_280218_(WIDGETS_LOCATION, i + 91, this.screenHeight - 23, 53, 22, 29, 24);
            }
         }

         p_282108_.m_280168_().popPose();
         int l = 1;

         for(int i1 = 0; i1 < 9; ++i1) {
            int j1 = i - 90 + i1 * 20 + 2;
            int k1 = this.screenHeight - 16 - 3;
            this.m_280585_(p_282108_, j1, k1, p_283031_, player, player.getInventory().items.get(i1), l++);
         }

         if (!itemstack.isEmpty()) {
            int i2 = this.screenHeight - 16 - 3;
            if (humanoidarm == HumanoidArm.LEFT) {
               this.m_280585_(p_282108_, i - 91 - 26, i2, p_283031_, player, itemstack, l++);
            } else {
               this.m_280585_(p_282108_, i + 91 + 10, i2, p_283031_, player, itemstack, l++);
            }
         }
         ...
         if (this.minecraft.options.attackIndicator().get() == AttackIndicatorStatus.HOTBAR) {
            ...
            if (f < 1.0F) {
               ...
               int l1 = (int)(f * 19.0F);
               p_282108_.m_280218_(f_279580_, k2, j2, 0, 94, 18, 18);
               p_282108_.m_280218_(f_279580_, k2, j2 + 18 - l1, 18, 112 - l1, 18, l1);
            }
         }
   ...
   public void m_280069_(PlayerRideableJumping p_282774_, GuiGraphics p_282939_, int p_283351_) {
      this.minecraft.getProfiler().push("jumpBar");
      float f = this.minecraft.player.getJumpRidingScale();
      int i = 182;
      int j = (int)(f * 183.0F);
      int k = this.screenHeight - 32 + 3;
      p_282939_.m_280218_(f_279580_, p_283351_, k, 0, 84, 182, 5);
      if (p_282774_.getJumpCooldown() > 0) {
         p_282939_.m_280218_(f_279580_, p_283351_, k, 0, 74, 182, 5);
      } else if (j > 0) {
         p_282939_.m_280218_(f_279580_, p_283351_, k, 0, 89, j, 5);
      }

      this.minecraft.getProfiler().pop();
   }

   public void m_280276_(GuiGraphics p_281906_, int p_282731_) {
      ...
      if (i > 0) {
         ...
         p_281906_.m_280218_(f_279580_, p_282731_, l, 0, 64, 182, 5);
         if (k > 0) {
            p_281906_.m_280218_(f_279580_, p_282731_, l, 0, 69, k, 5);
         }
      }
      ...
      if (this.minecraft.player.experienceLevel > 0) {
         ...
         p_281906_.m_280056_(this.getFont(), s, i1 + 1, j1, 0, false);
         p_281906_.m_280056_(this.getFont(), s, i1 - 1, j1, 0, false);
         p_281906_.m_280056_(this.getFont(), s, i1, j1 + 1, 0, false);
         p_281906_.m_280056_(this.getFont(), s, i1, j1 - 1, 0, false);
         p_281906_.m_280056_(this.getFont(), s, i1, j1, 8453920, false);
         this.minecraft.getProfiler().pop();
      }
   ...
   public void m_280295_(GuiGraphics p_283501_) {
      ...
      if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
         ...
         if (l > 0) {
            p_283501_.m_280509_(j - 2, k - 2, j + i + 2, k + 9 + 2, this.minecraft.options.getBackgroundColor(0));
            ...
            if (font == null) {
               p_283501_.m_280430_(this.getFont(), highlightTip, j, k, 16777215 + (l << 24));
            } else {
   ...
   public void m_280339_(GuiGraphics p_281825_) {
      ...
      p_281825_.m_280430_(this.getFont(), component, this.screenWidth - i - 10, 5, 16777215);
      this.minecraft.getProfiler().pop();
   }
   ...
   public void m_280030_(GuiGraphics p_282008_, Objective p_283455_) {
      ...
      for(Pair<Score, Component> pair : list1) {
         ...
         p_282008_.m_280509_(l2 - 2, k1, l1, k1 + 9, i1);
         p_282008_.m_280614_(this.getFont(), component2, l2, k1, -1, false);
         p_282008_.m_280056_(this.getFont(), s, l1 - this.getFont().width(s), k1, -1, false);
         if (l == collection.size()) {
            p_282008_.m_280509_(l2 - 2, k1 - 9 - 1, l1, k1 - 1, j1);
            p_282008_.m_280509_(l2 - 2, k1 - 1, l1, k1, i1);
            p_282008_.m_280614_(this.getFont(), component, l2 + j / 2 - i / 2, k1 - 9, -1, false);
         }
      }
   ...
   private void m_280173_(GuiGraphics p_283143_) {
      Player player = this.getCameraPlayer();
      if (player != null) {
         ...
         for(int k3 = 0; k3 < 10; ++k3) {
            if (i3 > 0) {
               int l3 = i1 + k3 * 8;
               if (k3 * 2 + 1 < i3) {
                  p_283143_.m_280218_(f_279580_, l3, k2, 34, 9, 9, 9);
               }

               if (k3 * 2 + 1 == i3) {
                  p_283143_.m_280218_(f_279580_, l3, k2, 25, 9, 9, 9);
               }

               if (k3 * 2 + 1 > i3) {
                  p_283143_.m_280218_(f_279580_, l3, k2, 16, 9, 9, 9);
               }
            }
         }
         ...
         if (k5 == 0) {
            ...
            for(int i4 = 0; i4 < 10; ++i4) {
               ...
               int i5 = j1 - i4 * 8 - 9;
               p_283143_.m_280218_(f_279580_, i5, j4, 16 + l4 * 9, 27, 9, 9);
               if (i4 * 2 + 1 < l) {
                  p_283143_.m_280218_(f_279580_, i5, j4, k4 + 36, 27, 9, 9);
               }

               if (i4 * 2 + 1 == l) {
                  p_283143_.m_280218_(f_279580_, i5, j4, k4 + 45, 27, 9, 9);
               }
            }
         ...
         if (player.isEyeInFluid(FluidTags.WATER) || i6 < l5) {
            ...
            for(int j5 = 0; j5 < k6 + l6; ++j5) {
               if (j5 < k6) {
                  p_283143_.m_280218_(f_279580_, j1 - j5 * 8 - 9, l2, 16, 18, 9, 9);
               } else {
                  p_283143_.m_280218_(f_279580_, j1 - j5 * 8 - 9, l2, 25, 18, 9, 9);
               }
            }
         }
   ...
   protected void renderHearts(GuiGraphics p_282497_, Player p_168690_, int p_168691_, int p_168692_, int p_168693_, int p_168694_, float p_168695_, int p_168696_, int p_168697_, int p_168698_, boolean p_168699_) {
      ...
      int i = 9 * (p_168690_.getLevel().getLevelData().isHardcore() ? 5 : 0);
      ...
      for(int i1 = j + k - 1; i1 >= 0; --i1) {
         ...
         this.m_280593_(p_282497_, Gui.HeartType.CONTAINER, l1, i2, i, p_168699_, false);
         int j2 = i1 * 2;
         boolean flag = i1 >= j;
         if (flag) {
            int k2 = j2 - l;
            if (k2 < p_168698_) {
               ...
               this.m_280593_(p_282497_, gui$hearttype == Gui.HeartType.WITHERED ? gui$hearttype : Gui.HeartType.ABSORBING, l1, i2, i, false, flag1);
            }
         }

         if (p_168699_ && j2 < p_168697_) {
            boolean flag2 = j2 + 1 == p_168697_;
            this.m_280593_(p_282497_, gui$hearttype, l1, i2, i, true, flag2);
         }

         if (j2 < p_168696_) {
            boolean flag3 = j2 + 1 == p_168696_;
            this.m_280593_(p_282497_, gui$hearttype, l1, i2, i, false, flag3);
         }
      }

   }

   private void m_280593_(GuiGraphics p_283024_, Gui.HeartType p_281393_, int p_283636_, int p_283279_, int p_283188_, boolean p_283440_, boolean p_282496_) {
      p_283024_.m_280218_(f_279580_, p_283636_, p_283279_, p_281393_.getX(p_282496_, p_283440_), p_283188_, 9, 9);
   }

   private void m_280250_(GuiGraphics p_283368_) {
      LivingEntity livingentity = this.getPlayerVehicleWithHealth();
         ...
         if (i != 0) {
            ...
            for(boolean flag = false; i > 0; j1 += 20) {
               ...
               for(int l1 = 0; l1 < k1; ++l1) {
                  ...
                  int j2 = 0;
                  int k2 = l - l1 * 8 - 9;
                  p_283368_.m_280218_(f_279580_, k2, i1, 52 + j2 * 9, 9, 9, 9);
                  if (l1 * 2 + 1 + j1 < j) {
                     p_283368_.m_280218_(f_279580_, k2, i1, 88, 9, 9, 9);
                  }

                  if (l1 * 2 + 1 + j1 == j) {
                     p_283368_.m_280218_(f_279580_, k2, i1, 97, 9, 9, 9);
                  }
               }
   ...
   protected void m_280155_(GuiGraphics p_282304_, ResourceLocation p_281622_, float p_281504_) {
      ...
      p_282304_.m_280398_(p_281622_, 0, 0, -90, 0.0F, 0.0F, this.screenWidth, this.screenHeight, this.screenWidth, this.screenHeight);
   ...
   public void m_280278_(GuiGraphics p_282069_, float p_283442_) {
      ...
      int i1 = k + i;
      int j1 = l + j;
      p_282069_.m_280398_(SPYGLASS_SCOPE_LOCATION, k, l, -90, 0.0F, 0.0F, i, j, i, j);
      p_282069_.m_285795_(RenderType.m_286086_(), 0, j1, this.screenWidth, this.screenHeight, -90, -16777216);
      p_282069_.m_285795_(RenderType.m_286086_(), 0, 0, this.screenWidth, l, -90, -16777216);
      p_282069_.m_285795_(RenderType.m_286086_(), 0, l, k, j1, -90, -16777216);
      p_282069_.m_285795_(RenderType.m_286086_(), i1, l, this.screenWidth, j1, -90, -16777216);
   }
   ...
   private void updateVignetteBrightness(Entity p_93021_) {
      if (p_93021_ != null) {
         ...
         float f = LightTexture.getBrightness(p_93021_.getLevel().dimensionType(), p_93021_.getLevel().getMaxLocalRawBrightness(blockpos));
   ...
   public void m_280154_(GuiGraphics p_283063_, Entity p_283439_) {
      ...
      if (f > 0.0F) {
         ...
         p_283063_.m_280246_(0.0F, f, f, 1.0F);
      } else {
         float f1 = this.vignetteBrightness;
         f1 = Mth.clamp(f1, 0.0F, 1.0F);
         p_283063_.m_280246_(f1, f1, f1, 1.0F);
      }

      p_283063_.m_280398_(VIGNETTE_LOCATION, 0, 0, -90, 0.0F, 0.0F, this.screenWidth, this.screenHeight, this.screenWidth, this.screenHeight);
      RenderSystem.depthMask(true);
      RenderSystem.enableDepthTest();
      p_283063_.m_280246_(1.0F, 1.0F, 1.0F, 1.0F);
      RenderSystem.defaultBlendFunc();
   }
   ...
   protected void m_280379_(GuiGraphics p_283375_, float p_283296_) {
      ...
      RenderSystem.disableDepthTest();
      RenderSystem.depthMask(false);
      p_283375_.m_280246_(1.0F, 1.0F, 1.0F, p_283296_);
      ...
      p_283375_.m_280159_(0, 0, -90, this.screenWidth, this.screenHeight, textureatlassprite);
      RenderSystem.depthMask(true);
      RenderSystem.enableDepthTest();
      p_283375_.m_280246_(1.0F, 1.0F, 1.0F, 1.0F);
   }

   private void m_280585_(GuiGraphics p_283283_, int p_283213_, int p_281301_, float p_281885_, Player p_283644_, ItemStack p_283317_, int p_283261_) {
      if (!p_283317_.isEmpty()) {
         float f = (float)p_283317_.getPopTime() - p_281885_;
         if (f > 0.0F) {
            float f1 = 1.0F + f / 5.0F;
            p_283283_.m_280168_().pushPose();
            p_283283_.m_280168_().translate((float)(p_283213_ + 8), (float)(p_281301_ + 12), 0.0F);
            p_283283_.m_280168_().scale(1.0F / f1, (f1 + 1.0F) / 2.0F, 1.0F);
            p_283283_.m_280168_().translate((float)(-(p_283213_ + 8)), (float)(-(p_281301_ + 12)), 0.0F);
         }

         p_283283_.m_280638_(p_283644_, p_283317_, p_283213_, p_281301_, p_283261_);
         if (f > 0.0F) {
            p_283283_.m_280168_().popPose();
         }

         p_283283_.m_280370_(this.minecraft.font, p_283317_, p_283213_, p_281301_);
      }
   }
   ...
   private void m_280266_(GuiGraphics p_282761_) {
      if (this.minecraft.options.showAutosaveIndicator().get() && (this.autosaveIndicatorValue > 0.0F || this.lastAutosaveIndicatorValue > 0.0F)) {
         ...
         if (i > 8) {
            ...
            p_282761_.m_280430_(font, SAVING_TEXT, this.screenWidth - j - 10, this.screenHeight - 15, k);
         }
      }
