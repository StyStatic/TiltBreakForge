...
public abstract class AbstractSliderButton extends AbstractWidget {
   ...
   public void renderWidget(GuiGraphics p_283427_, int p_281447_, int p_282852_, float p_282409_) {
      ...
      p_283427_.m_280246_(1.0F, 1.0F, 1.0F, this.alpha);
      RenderSystem.enableBlend();
      RenderSystem.defaultBlendFunc();
      RenderSystem.enableDepthTest();
      p_283427_.m_280027_(SLIDER_LOCATION, this.getX(), this.getY(), this.getWidth(), this.getHeight(), 20, 4, 200, 20, 0, this.getTextureY());
      p_283427_.m_280027_(SLIDER_LOCATION, this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 8, 20, 20, 4, 200, 20, 0, this.getHandleTextureY());
      p_283427_.m_280246_(1.0F, 1.0F, 1.0F, 1.0F);
      int i = this.active ? 16777215 : 10526880;
      this.m_280372_(p_283427_, minecraft.font, 2, i | Mth.ceil(this.alpha * 255.0F) << 24);
   }
   ...
   public boolean keyPressed(int p_93596_, int p_93597_, int p_93598_) {
      if (CommonInputs.m_278691_(p_93596_)) {
