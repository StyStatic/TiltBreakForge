...
public abstract class WarningScreen extends Screen {
   ...
   public void m_88315_(GuiGraphics p_282073_, int p_283174_, int p_282617_, float p_282654_) {
      this.m_280273_(p_282073_);
      this.m_280550_(p_282073_);
      int i = this.width / 2 - this.message.getWidth() / 2;
      this.message.renderLeftAlignedNoShadow(p_282073_, i, 70, this.getLineHeight(), 16777215);
      super.m_88315_(p_282073_, p_283174_, p_282617_, p_282654_);
   }

   protected void m_280550_(GuiGraphics p_281725_) {
      p_281725_.m_280430_(this.font, this.title, 25, 30, 16777215);
   }
