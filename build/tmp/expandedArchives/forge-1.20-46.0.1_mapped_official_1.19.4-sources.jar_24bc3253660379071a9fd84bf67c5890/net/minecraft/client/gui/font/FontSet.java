...
public class FontSet implements AutoCloseable {
   ...
   public void reload(List<GlyphProvider> p_95072_) {
      this.closeProviders();
      this.closeTextures();
      this.glyphs.m_284192_();
      this.glyphInfos.m_284192_();
   ...
   public GlyphInfo getGlyphInfo(int p_243235_, boolean p_243251_) {
      return this.glyphInfos.m_284450_(p_243235_, this::computeGlyphInfo).select(p_243251_);
   }
   ...
   public BakedGlyph getGlyph(int p_95079_) {
      return this.glyphs.m_284450_(p_95079_, this::computeBakedGlyph);
   }
