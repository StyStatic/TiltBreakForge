...
public class ChatScreen extends Screen {
   ...
   public void m_88315_(GuiGraphics p_282470_, int p_282674_, int p_282014_, float p_283132_) {
      p_282470_.m_280509_(2, this.height - 14, this.width - 2, this.height - 2, this.minecraft.options.getBackgroundColor(Integer.MIN_VALUE));
      this.input.m_88315_(p_282470_, p_282674_, p_282014_, p_283132_);
      super.m_88315_(p_282470_, p_282674_, p_282014_, p_283132_);
      this.commandSuggestions.m_280540_(p_282470_, p_282674_, p_282014_);
      ...
      if (guimessagetag != null && guimessagetag.text() != null) {
         p_282470_.m_280245_(this.font, this.font.split(guimessagetag.text(), 210), p_282674_, p_282014_);
      } else {
         Style style = this.getComponentStyleAt((double)p_282674_, (double)p_282014_);
         if (style != null && style.getHoverEvent() != null) {
            p_282470_.m_280304_(this.font, style, p_282674_, p_282014_);
         }
      }
