...
public class GhostRecipe {
   ...
   public void m_280269_(GuiGraphics p_282081_, Minecraft p_281341_, int p_283169_, int p_282326_, boolean p_282174_, float p_282256_) {
      ...
      for(int i = 0; i < this.ingredients.size(); ++i) {
         ...
         if (i == 0 && p_282174_) {
            p_282081_.m_280509_(j - 4, k - 4, j + 20, k + 20, 822018048);
         } else {
            p_282081_.m_280509_(j, k, j + 16, k + 16, 822018048);
         }

         ItemStack itemstack = ghostrecipe$ghostingredient.getItem();
         p_282081_.m_280203_(itemstack, j, k);
         p_282081_.m_285944_(RenderType.m_285811_(), j, k, j + 16, k + 16, 822083583);
         if (i == 0) {
            p_282081_.m_280370_(p_281341_.font, itemstack, j, k);
         }
      }
