...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
   ...
   protected void m_280003_(GuiGraphics p_283369_, int p_282699_, int p_281296_) {
      p_283369_.m_280653_(this.font, PRIMARY_EFFECT_LABEL, 62, 10, 14737632);
      p_283369_.m_280653_(this.font, SECONDARY_EFFECT_LABEL, 169, 10, 14737632);
   }

   protected void renderBg(GuiGraphics p_282454_, float p_282185_, int p_282362_, int p_282987_) {
      int i = (this.width - this.imageWidth) / 2;
      int j = (this.height - this.imageHeight) / 2;
      p_282454_.m_280218_(BEACON_LOCATION, i, j, 0, 0, this.imageWidth, this.imageHeight);
      p_282454_.m_280168_().pushPose();
      p_282454_.m_280168_().translate(0.0F, 0.0F, 100.0F);
      p_282454_.m_280480_(new ItemStack(Items.NETHERITE_INGOT), i + 20, j + 109);
      p_282454_.m_280480_(new ItemStack(Items.EMERALD), i + 41, j + 109);
      p_282454_.m_280480_(new ItemStack(Items.DIAMOND), i + 41 + 22, j + 109);
      p_282454_.m_280480_(new ItemStack(Items.GOLD_INGOT), i + 42 + 44, j + 109);
      p_282454_.m_280480_(new ItemStack(Items.IRON_INGOT), i + 42 + 66, j + 109);
      p_282454_.m_280168_().popPose();
   }
   ...
   class BeaconPowerButton extends BeaconScreen.BeaconScreenButton {
      ...
      protected void renderIcon(GuiGraphics p_282265_) {
         p_282265_.m_280159_(this.getX() + 2, this.getY() + 2, 0, 18, 18, this.sprite);
      }
   ...
   abstract static class BeaconScreenButton extends AbstractButton implements BeaconScreen.BeaconButton {
      ...
      public void renderWidget(GuiGraphics p_281837_, int p_281780_, int p_283603_, float p_283562_) {
         ...
         p_281837_.m_280218_(BeaconScreen.BEACON_LOCATION, this.getX(), this.getY(), j, 219, this.width, this.height);
   ...
   abstract static class BeaconSpriteScreenButton extends BeaconScreen.BeaconScreenButton {
      ...
      protected void renderIcon(GuiGraphics p_283624_) {
         p_283624_.m_280218_(BeaconScreen.BEACON_LOCATION, this.getX() + 2, this.getY() + 2, this.iconX, this.iconY, 18, 18);
      }
   }
