...
public class TelemetryEventWidget extends AbstractScrollWidget {
   ...
   protected void m_239197_(GuiGraphics p_283081_, int p_283426_, int p_282414_, float p_283358_) {
      int i = this.getY() + this.innerPadding();
      int j = this.getX() + this.innerPadding();
      p_283081_.m_280168_().pushPose();
      p_283081_.m_280168_().translate((double)j, (double)i, 0.0D);
      this.content.container().visitWidgets((p_280896_) -> {
         p_280896_.m_88315_(p_283081_, p_283426_, p_282414_, p_283358_);
      });
      p_283081_.m_280168_().popPose();
   }
