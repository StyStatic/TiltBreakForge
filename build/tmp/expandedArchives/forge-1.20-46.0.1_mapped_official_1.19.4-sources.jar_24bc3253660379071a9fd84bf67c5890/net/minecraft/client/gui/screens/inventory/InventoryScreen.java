...
public class InventoryScreen extends EffectRenderingInventoryScreen<InventoryMenu> implements RecipeUpdateListener {
   ...
   protected void m_280003_(GuiGraphics p_281654_, int p_283517_, int p_283464_) {
      p_281654_.m_280614_(this.font, this.title, this.titleLabelX, this.titleLabelY, 4210752, false);
   }

   public void m_88315_(GuiGraphics p_283246_, int p_98876_, int p_98877_, float p_98878_) {
      this.m_280273_(p_283246_);
      if (this.recipeBookComponent.isVisible() && this.widthTooNarrow) {
         this.renderBg(p_283246_, p_98878_, p_98876_, p_98877_);
         this.recipeBookComponent.m_88315_(p_283246_, p_98876_, p_98877_, p_98878_);
      } else {
         this.recipeBookComponent.m_88315_(p_283246_, p_98876_, p_98877_, p_98878_);
         super.m_88315_(p_283246_, p_98876_, p_98877_, p_98878_);
         this.recipeBookComponent.m_280128_(p_283246_, this.leftPos, this.topPos, false, p_98878_);
      }

      this.m_280072_(p_283246_, p_98876_, p_98877_);
      this.recipeBookComponent.m_280545_(p_283246_, this.leftPos, this.topPos, p_98876_, p_98877_);
   ...
   protected void renderBg(GuiGraphics p_281500_, float p_281299_, int p_283481_, int p_281831_) {
      int i = this.leftPos;
      int j = this.topPos;
      p_281500_.m_280218_(INVENTORY_LOCATION, i, j, 0, 0, this.imageWidth, this.imageHeight);
   ...
   public static void renderEntityInInventoryFollowsAngle(GuiGraphics p_282802_, int p_275688_, int p_275245_, int p_275535_, float angleXComponent, float angleYComponent, LivingEntity p_275689_) {
      ...
      m_280432_(p_282802_, p_275688_, p_275245_, p_275535_, quaternionf, quaternionf1, p_275689_);
   ...
   public static void m_280432_(GuiGraphics p_282665_, int p_283622_, int p_283401_, int p_281360_, Quaternionf p_281880_, @Nullable Quaternionf p_282882_, LivingEntity p_282466_) {
      p_282665_.m_280168_().pushPose();
      p_282665_.m_280168_().translate((double)p_283622_, (double)p_283401_, 50.0D);
      p_282665_.m_280168_().mulPoseMatrix((new Matrix4f()).scaling((float)p_281360_, (float)p_281360_, (float)(-p_281360_)));
      p_282665_.m_280168_().mulPose(p_281880_);
      ...
      RenderSystem.runAsFancy(() -> {
         entityrenderdispatcher.render(p_282466_, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, p_282665_.m_280168_(), p_282665_.m_280091_(), 15728880);
      });
      p_282665_.m_280262_();
      entityrenderdispatcher.setRenderShadow(true);
      p_282665_.m_280168_().popPose();
