...
public interface StructureSets {
   static void bootstrap(BootstapContext<StructureSet> p_256148_) {
      ...
      p_256148_.register(BuiltinStructureSets.f_276475_, new StructureSet(holdergetter.getOrThrow(BuiltinStructures.f_276588_), new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 83469867)));
   }
}