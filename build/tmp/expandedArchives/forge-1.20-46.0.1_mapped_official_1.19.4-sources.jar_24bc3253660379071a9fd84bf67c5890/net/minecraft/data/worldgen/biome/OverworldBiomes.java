...
public class OverworldBiomes {
   ...
   public static Biome sparseJungle(HolderGetter<PlacedFeature> p_255977_, HolderGetter<ConfiguredWorldCarver<?>> p_256531_) {
      ...
      return m_284525_(p_255977_, p_256531_, 0.8F, false, true, false, mobspawnsettings$builder, Musics.createGameMusic(SoundEvents.f_283878_));
   }
   ...
   public static Biome jungle(HolderGetter<PlacedFeature> p_256033_, HolderGetter<ConfiguredWorldCarver<?>> p_255651_) {
      ...
      return m_284525_(p_256033_, p_255651_, 0.9F, false, false, true, mobspawnsettings$builder, Musics.createGameMusic(SoundEvents.f_283786_));
   }
   ...
   public static Biome bambooJungle(HolderGetter<PlacedFeature> p_255817_, HolderGetter<ConfiguredWorldCarver<?>> p_256096_) {
      ...
      return m_284525_(p_255817_, p_256096_, 0.9F, true, false, true, mobspawnsettings$builder, Musics.createGameMusic(SoundEvents.f_283944_));
   }

   private static Biome m_284525_(HolderGetter<PlacedFeature> p_285208_, HolderGetter<ConfiguredWorldCarver<?>> p_285276_, float p_285079_, boolean p_285393_, boolean p_285109_, boolean p_285122_, MobSpawnSettings.Builder p_285449_, Music p_285440_) {
   ...
   public static Biome desert(HolderGetter<PlacedFeature> p_256064_, HolderGetter<ConfiguredWorldCarver<?>> p_255852_) {
      ...
      return biome(false, 2.0F, 0.0F, mobspawnsettings$builder, biomegenerationsettings$builder, Musics.createGameMusic(SoundEvents.f_283840_));
   }
   ...
   public static Biome forest(HolderGetter<PlacedFeature> p_255788_, HolderGetter<ConfiguredWorldCarver<?>> p_256461_, boolean p_194892_, boolean p_194893_, boolean p_194894_) {
      ...
      Music music;
      if (p_194894_) {
         music = Musics.createGameMusic(SoundEvents.f_283817_);
         ...
         music = Musics.createGameMusic(SoundEvents.f_283788_);
   ...
   public static Biome darkForest(HolderGetter<PlacedFeature> p_256140_, HolderGetter<ConfiguredWorldCarver<?>> p_256223_) {
      ...
      BiomeDefaultFeatures.addDefaultMushrooms(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultExtraVegetation(biomegenerationsettings$builder);
      Music music = Musics.createGameMusic(SoundEvents.f_283788_);
