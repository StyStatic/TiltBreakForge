...
public class Structures {
   ...
   public static void bootstrap(BootstapContext<Structure> p_256072_) {
      ...
      p_256072_.register(BuiltinStructures.f_276588_, new JigsawStructure(structure(holdergetter.getOrThrow(BiomeTags.f_276517_), Map.of(), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.BURY), holdergetter1.getOrThrow(TrailRuinsStructurePools.f_276659_), 7, ConstantHeight.of(VerticalAnchor.absolute(-15)), false, Heightmap.Types.WORLD_SURFACE_WG));
   }
}