...
public class RealmsNotificationsScreen extends RealmsScreen {
   ...
   public void m_88315_(GuiGraphics p_282587_, int p_282992_, int p_283028_, float p_281605_) {
      if (validClient) {
         this.m_280451_(p_282587_, p_282992_, p_283028_);
      }

      super.m_88315_(p_282587_, p_282992_, p_283028_, p_281605_);
   }

   private void m_280451_(GuiGraphics p_282966_, int p_283380_, int p_283457_) {
      ...
      if (hasUnseenNotifications) {
         p_282966_.m_280163_(UNSEEN_NOTIFICATION_ICON_LOCATION, l - j1 + 5, i1 + 3, 0.0F, 0.0F, 10, 10, 10, 10);
         j1 += 14;
      }

      if (this.currentConfiguration != null && this.currentConfiguration.showOldNotifications()) {
         if (hasUnreadNews) {
            p_282966_.m_280168_().pushPose();
            p_282966_.m_280168_().scale(0.4F, 0.4F, 0.4F);
            p_282966_.m_280163_(NEWS_ICON_LOCATION, (int)((double)(l + 2 - j1) * 2.5D), (int)((double)i1 * 2.5D), 0.0F, 0.0F, 40, 40, 40, 40);
            p_282966_.m_280168_().popPose();
            j1 += 14;
         }

         if (i != 0) {
            p_282966_.m_280163_(INVITE_ICON_LOCATION, l - j1, i1 - 6, 0.0F, 0.0F, 15, 25, 31, 25);
            j1 += 16;
         }
         ...
         if (trialAvailable) {
            ...
            p_282966_.m_280163_(TRIAL_ICON_LOCATION, l + 4 - j1, i1 + 4, 0.0F, (float)k1, 8, 8, 8, 16);
         }
      }
