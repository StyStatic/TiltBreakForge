...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void m_88315_(GuiGraphics p_283210_, int p_283172_, int p_281531_, float p_283191_) {
      this.m_280273_(p_283210_);
      p_283210_.m_280653_(this.font, this.title, this.width / 2, 17, 16777215);
      p_283210_.m_280614_(this.font, NAME_LABEL, this.column1X + this.columnWidth / 2 - this.font.width(NAME_LABEL) / 2, row(0) - 5, 16777215, false);
      this.nameEdit.m_88315_(p_283210_, p_283172_, p_281531_, p_283191_);
      super.m_88315_(p_283210_, p_283172_, p_281531_, p_283191_);
   }
